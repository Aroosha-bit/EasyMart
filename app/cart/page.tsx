...
export default function CartPage({ data }: any) {
  ...
  const totalPrice = cartItems.reduce(
    (total: any, item: any) =>
      total + parseFloat(String(item.price).replace("$", "")) * item.quantity,
    0,
  );
              ...
              <div className="sticky top-24">
                <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                  ...
                  <div className="p-5">
                    ...
                    <button onClick={checkOutButton} className="w-full bg-[#B6349A] hover:bg-[#9a2c84] transition-colors text-white font-semibold rounded-xl py-3.5 flex items-center justify-center px-5">
